...
- (UIButton *)playButton {
    if (_playButton == nil) {
        ...
        [btn setImage:[UIImage nim_customImageInKit:@"aio_record_play_nor"] forState:UIControlStateNormal];
        [btn setImage:[UIImage nim_customImageInKit:@"aio_record_play_press"] forState:UIControlStateHighlighted];
        [btn setImage:[UIImage nim_customImageInKit:@"aio_record_stop_nor"] forState:UIControlStateSelected];
        UIImage *image = [UIImage nim_customImageInKit:@"aio_voice_button_nor"];
