...
- (void)setupPlayButton {
    UIImage *image = [UIImage nim_customImageInKit:@"aio_voiceChange_effect_0"];
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
    [button setBackgroundImage:image forState:UIControlStateNormal];
    [button setImage:nil forState:UIControlStateNormal];
    [button setImage:[UIImage nim_customImageInKit:@"aio_voiceChange_effect_selected"] forState:UIControlStateSelected];
    [button setImage:[UIImage nim_customImageInKit:@"aio_voiceChange_effect_pressed"] forState:UIControlStateHighlighted];
...
- (void)setupTitleButton {
    UIImage *image = [UIImage nim_customImageInKit:@"aio_voiceChange_text_select"];
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
...
- (void)setTitle:(NSString *)title {
    ...
    [self.playButton setBackgroundImage:[UIImage nim_customImageInKit:_imageName] forState:UIControlStateNormal];
}
