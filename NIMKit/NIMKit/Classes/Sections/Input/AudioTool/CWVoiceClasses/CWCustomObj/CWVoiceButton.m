...
+ (instancetype)buttonWithBackImageNor:(NSString *)backImageNor backImageSelected:(NSString *)backImageSelected imageNor:(NSString *)imageNor imageSelected:(NSString *)imageSelected frame:(CGRect)frame isMicPhone:(BOOL)isMicPhone{
    ...
    UIImage *normalImage = [UIImage nim_customImageInKit:backImageNor]; //aio_voice_button_press
    UIImage *selectedImage = [UIImage nim_customImageInKit:backImageSelected];
    ...
    [btn setImage:[UIImage nim_customImageInKit:backImageNor] forState:UIControlStateNormal];
    [btn setImage:[UIImage nim_customImageInKit:backImageSelected] forState:UIControlStateSelected];
